pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/khanalb58/metallb-deploy.git'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('khanalb-225')   // <---- Change this to match your kubernetes cluster credentials
    }
